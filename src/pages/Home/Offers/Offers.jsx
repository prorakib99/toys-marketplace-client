    ...
    return (
        <div className='bg-cover' style={{ backgroundImage: `url('${bg_img}')` }}>
            <div className='container mx-auto py-16 px-5'>
                <h2 className="text-pink-600 text-center text-4xl font-bold font-['Nunito'] leading-tight">
                    Our Offer
                </h2>
                <div className='grid md:grid-cols-2 pt-8 gap-10 items-center lg:px-16'>
                    <div>
                    ...
                    <div className='flex flex-col gap-8'>
                        <div className='bg-orange-50 rounded-lg border-2 border-dashed border-amber-400 flex items-center gap-4 p-[33px]'>
                            ...
                            <div>
                                <h4 className="text-amber-400 text-xl md:text-2xl font-bold font-['Nunito'] leading-tight">
                                    New Born & Baby Care Shop
                                </h4>
                                <p className="text-neutral-400 text-sm font-semibold font-['Nunito'] mt-3 leading-tight">
                        ...
                        <div className='bg-violet-50 rounded-lg border-2 border-dashed border-indigo-400 flex items-center gap-4 p-[33px]'>
                            ...
                            <div>
                                <h4 className="text-indigo-400 text-xl md:text-2xl font-bold font-['Nunito'] leading-tight">
                                    New Born & Baby Care Shop
                                </h4>
                                <p className="text-neutral-400 text-sm font-semibold font-['Nunito'] mt-3 leading-tight">
                                    Mauris vitae erat non nisi consequat
                        ...
                        <div className='bg-slate-50 rounded-lg border-2 border-dashed border-teal-500 flex items-center gap-4 p-[33px]'>
                            ...
                            <div>
                                <h4 className="text-teal-500 text-xl md:text-2xl font-bold font-['Nunito'] leading-tight">
                                    New Born & Baby Care Shop
                                </h4>
                                <p className="text-neutral-400 text-sm font-semibold font-['Nunito'] mt-3 leading-tight">
                                    Mauris vitae erat non nisi consequat
